...
def generate_launch_description():
    ...
    use_simulator = LaunchConfiguration('simulator') # using simulator or rosbag to publish lidar data
    ...
    fast_lio_node = Node(
        ...
        output="screen",
        parameters=[
            PathJoinSubstitution([default_config_path, "3dslam_config.yaml"]),
