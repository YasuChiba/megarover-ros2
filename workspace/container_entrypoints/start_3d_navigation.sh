...
source /opt/ros/humble/setup.bash && \
    ...
    ros2 launch c_megarover navigation_launch.py simulator:=false rviz:=true map_file_path:=/home/user/workspace/maps/map2.pcd map_2d_file_path:=/home/user/workspace/maps/map2.yaml &
